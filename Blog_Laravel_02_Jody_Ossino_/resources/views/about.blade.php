...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('https://files.spazioweb.it/38/b3/38b33ece-2d5a-44ce-961a-8e456ce0082f.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>About</h1>
                            <span class="subheading">Scopri chi siamo!</span>
                        </div>
                    </div>
                </div>
            </div>
