...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('https://www.orangenergy.com/wp-content/uploads/2016/04/servizi.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Details</h1>
                            <span class="subheading">Scopri i dettagli!</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="mb-4">
            <div class="container p-5">
                  ...
                  <div class="card-body">
                    ...
                    <a href="#"><button type="button" class="btn shadow-lg rounded-5 text-center">Maggiori info <i class="fa-regular fa-hand-pointer" style="color: #ffffff;"></i></button></a>
                  </div>
                 </div>
                    </div>
                </div>
